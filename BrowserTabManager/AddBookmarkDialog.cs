...
namespace BrowserTabManager
{
    public class AddBookmarkDialog : Window
    {
        ...
        public AddBookmarkDialog()
        {
            ...
            titleBox = new TextBox { Text = string.Empty };
            ...
            urlBox = new TextBox { Text = string.Empty };
            ...
            addButton = new Button { Content = "Add", Width = 70, Margin = new Thickness(0, 10, 10, 0), IsDefault = true };
